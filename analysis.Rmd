...
ggplot(train_test, aes(x = "", y = count, fill = set)) + 
  geom_bar(stat = "identity", width = 1) + 
  coord_polar("y", start = 0) + 
  labs(title = "Train-test sets proportions", fill = "Set") + 
  theme_minimal()
...
- all the other variables are encoded as numeric but they are actually categorical variables. 
